...
namespace MicroservicoAPI
{
    public class Startup
    {
        ...
        {
            //var apiKeyConfig = Configuration.Get<ServiceSettings>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MicroservicoAPI", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MicroservicoAPI v1"));
            }
